                ...
                <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
                    <article className="mx-auto flex flex-row w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                        <header className="mb-4 mt-10 lg:mb-6 not-format">
                            <Image className='rounded-lg' src={"/projetos/seeds/logo.jpg"} alt="" width={200} height={200}></Image>
                        </header>

                        <div className='h-screen'>
                            <h1 className="mb-4 mt-10 ml-10 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">Seeds</h1>

                            <p className="lead ml-10">Uma empresa dos curso de engenharia da computação e ciência da computação</p>
                        </div>
